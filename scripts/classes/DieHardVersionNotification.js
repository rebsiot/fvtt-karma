...
export default class DieHardVersionNotification {
	static checkVersion() {
		...
		if (game.user.isGM && game.user.getFlag("foundry-die-hard", "versionNotification") !== notificationVersion) {
			...
			let commonFooter =
				"<p>To report problems:<ul><li>open a GitHub issue <a href='https://github.com/UranusBytes/foundry-die-hard/issues' target='_blank'>here</a></li><li>send a message on Discord to <a href='https://discordapp.com/users/530108795796455437' target='_blank'>Glutious#7241</a></li></ul></p>";
			let versionMessage = {
				1:
					"<b>v0.0.5</b><p>" +
